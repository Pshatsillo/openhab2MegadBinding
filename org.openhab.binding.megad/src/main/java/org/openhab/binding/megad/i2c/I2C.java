...
public class I2C {
    ...
    public void write_text(String string, String font, int column, int page) {
        ...
        for (int j = 0; j < splitByWordsData.length; j++) {
            int flag = 1;
            int wordsLenghthArray = printString(splitByWordsData[j]).length;
            for (int i = 0; i < wordsLenghthArray; i++) {
                i2c_send(Integer.toHexString(printString(splitByWordsData[j])[i + flag]));
                flag = flag * -1;
            }
    ...
    private int[] printString(String string) {
        ...
        for (int i = 0; i < string.length(); i++) {
            result = ArrayUtils.addAll(result, symbol.get(caracter[i]));
        }
    ...
    private void generateFonts(String font) {
        ...
        switch (font) {
            ...
            default:
                symbol.put("!", new int[] { 0x2F, 0xC0 });

                symbol.put("\"", new int[] { 0x00, 0xE0, 0x00, 0x00, 0x00, 0xE0 });
                /*
                 ...
                 */
                symbol.put("Е", new int[] { 0x3F, 0xC0, 0x22, 0x40, 0x22, 0x40, 0x22, 0x40, 0x22, 0x40 });
                /*
                 * 'Ж' => array (
                 ...
                 */
                symbol.put("Т", new int[] { 0x00, 0x40, 0x00, 0x40, 0x00, 0x40, 0x3F, 0xC0, 0x00, 0x40, 0x00, 0x40,
                        0x00, 0x40 });
                /*
                 ...
                 */
                symbol.put("е", new int[] { 0x1E, 0x00, 0x25, 0x00, 0x25, 0x00, 0x25, 0x00, 0x16, 0x00 });
                /*
                 ...
                 */
                symbol.put("с", new int[] { 0x1E, 0x00, 0x21, 0x00, 0x21, 0x00, 0x21, 0x00, 0x12, 0x00 });
                symbol.put("т", new int[] { 0x01, 0x00, 0x01, 0x00, 0x3F, 0x00, 0x01, 0x00, 0x01, 0x00 });
